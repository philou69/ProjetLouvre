...
class PaymentController extends Controller
{
	...
	public function doneAction(Request $request)
	{
		...
		if($status->isCaptured())
		{
			...
			$billetsPdf = $this->get('knp_snappy.pdf')->generateFromHtml($this->renderView('AppBundle:App:billet.html.twig', array('reservation' =>$reservation)), $this->getParameter('kernel.root_dir').'/../web/uploads/pdf/Reservation'.$reservation->getId().'.pdf');
